<header>
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light text-white">
            <a href="" class="navbar-brand"><img src="" alt="" class="image-logo"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                    <a href="" class="nav-link text-white"><span class="big"><i class="fas fa-home mr-1"></i></span>Inicio</a>
                    </li>
                    <li class="nav-item">
                    <a href="" class="nav-link text-white"><span class="big"><i class="fas fa-home mr-1"></i></span>Usuarios</a>
                    </li>
                    <li class="nav-item">
                        <form action="" class="tipe-form form-incline my-2 my-lg-0"> 
                ...
                <div class="links">
                <a href=""><span class="big"><i class="fas fa-envelope"></i></span><span class="mb-0 ml-1">Mensaje</span></a>
                </div>
                <div class="links">
